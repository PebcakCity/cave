...
namespace Cave.DeviceControllers.Projectors.NEC
{
    public class Command: Enumeration
    {
        ...
        public static Command DisplayMuteOn = new( 4, nameof(DisplayMuteOn), new List<byte> { 0x02, 0x10, 0x00, 0x00, 0x00, 0x12 } ) ;
        public static Command DisplayMuteOff = new( 5, nameof(DisplayMuteOff), new List<byte> { 0x02, 0x11, 0x00, 0x00, 0x00, 0x13 } );
        public static Command GetStatus = new( 6, nameof(GetStatus), new List<byte> { 0x00, 0xbf, 0x00, 0x00, 0x01, 0x02, 0xc2 } );
        public static Command GetInfo = new( 7, nameof(GetInfo), new List<byte> { 0x03, 0x8a, 0x00, 0x00, 0x00, 0x8d } );
        public static Command GetLampInfo = new( 8, nameof(GetLampInfo), new List<byte> { 0x03, 0x96, 0x00, 0x00, 0x02 } );
        public static Command GetErrors = new( 9, nameof(GetErrors), new List<byte> { 0x00, 0x88, 0x00, 0x00, 0x00, 0x88 } );
        public static Command GetModelNumber = new( 10, nameof(GetModelNumber), new List<byte> { 0x00, 0x85, 0x00, 0x00, 0x01, 0x04, 0x8a } );
        public static Command GetSerialNumber = new( 11, nameof(GetSerialNumber), new List<byte> { 0x00, 0xbf, 0x00, 0x00, 0x02, 0x01, 0x06, 0xc8 } );
