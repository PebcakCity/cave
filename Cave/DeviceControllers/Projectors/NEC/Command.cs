...
namespace Cave.DeviceControllers.Projectors.NEC
{
    public class Command: Enumeration
    {
        ...
        public static Command VolumeAdjust = new( 8, nameof(VolumeAdjust), new List<byte> { 0x03, 0x10, 0x00, 0x00, 0x05, 0x05, 0x00 } );
        public static Command GetStatus = new( 9, nameof(GetStatus), new List<byte> { 0x00, 0xbf, 0x00, 0x00, 0x01, 0x02, 0xc2 } );
        public static Command GetInfo = new( 10, nameof(GetInfo), new List<byte> { 0x03, 0x8a, 0x00, 0x00, 0x00, 0x8d } );
        public static Command GetLampInfo = new( 11, nameof(GetLampInfo), new List<byte> { 0x03, 0x96, 0x00, 0x00, 0x02 } );
        public static Command GetErrors = new( 12, nameof(GetErrors), new List<byte> { 0x00, 0x88, 0x00, 0x00, 0x00, 0x88 } );
        public static Command GetModelNumber = new( 13, nameof(GetModelNumber), new List<byte> { 0x00, 0x85, 0x00, 0x00, 0x01, 0x04, 0x8a } );
        public static Command GetSerialNumber = new( 14, nameof(GetSerialNumber), new List<byte> { 0x00, 0xbf, 0x00, 0x00, 0x02, 0x01, 0x06, 0xc8 } );
